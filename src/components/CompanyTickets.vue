<template>
  <div class="div-background">
    ...
    <div class="container-filter">
      <h4>Filter tickets of this company</h4>
      <br />
      <br />
...
export default {
  ...
  methods: {
    ...
    fetchDataWithFilterForCompany (e) {
      ...
      TicketClient.loadCompanyFilteredTickets(this.originCity, this.destinationCity, formatedDepartDate, formatedReturnDate, this.$parent, this.$parent.id);
