      ...
      <ul>
        <li v-bind:key="ticket.id" v-for="ticket in tickets">
          <div class="frame-ticket">
                  ...
                  >
                    ...
                    <div class="icon-edit">
                      ...
                      <svg
                        ...
                        v-on:click="editTicket(ticket.id)"
                      >
                        <path
                    ...
                    <div class="icon-delete">
                      ...
                      <svg
                        ...
                        fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg"
                        v-on:click="deleteTicket(ticket.id)"
                      >
                        <path
                          fill-rule="evenodd"
            ...
            <!-- DIV FOR BUTTON BOOK  -->
            <div class="div-book" v-if="currUserType != 'ADMINISTRATOR'">
              <button
                class="apply-button"
...
export default {
  ...
  methods: {
    ...
    deleteTicket (id) {
      ...
      if (r == true) {
        TicketClient.deleteTicket(id, this.$parent);
      }
    },
    editTicket (id) {
      this.$parent.$router.push({ name: 'updateTicket', params: { id: id } })
    },
